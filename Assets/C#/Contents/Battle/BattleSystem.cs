...
{   
    ...
    private CreatureController _actingEntity;
    ...
    public CreatureController ActingEntity { get => _actingEntity; set => _actingEntity = value; }
    ...
    private const string _playerPrefabPath = "Players/Hero";
    ...
    private void Init()
    {
        ...
        ActingEntity = GameObject.Find("@Players").transform.GetChild(0).GetComponent<CreatureController>();
        ////////////////////////////////////////////////
    }
    ...
    {   
        ...
        for (int z = 0; z < _gridSystem.PlayerGrid.Height; z += 2) // TODO - Test Code (z 좌표)
        {
            ...
            {
                _gridSystem.PlayerGrid.InstantiatePrefab(_playerPrefabPath, Define.CreatureType.Hero, x, z);
            }
        }
        for (int z = 0; z < _gridSystem.EnemyGrid.Height; z += 2) // TODO - Test Code (z 좌표)
        {
            ...
            {
                _gridSystem.EnemyGrid.InstantiatePrefab(_monsterPrefabPath, CreatureType.Monster, x, z, 180);
            }
        }
    }
    ...
    private void TriggerAction(SquareGridCell selectedCell)
    {
        switch (ActionType)
        {
            case Define.ActionType.Attack:
                ...
                // 만약 각 클래스에 구현된 함수라면
                // (ActingEntity as HeroController)?.Attack();
