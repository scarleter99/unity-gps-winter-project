...
{   
    ...
    // 해당 grid 좌표에 프리팹 생성
    public void InstantiatePrefab(string prefabPath, Define.CreatureType objectType, int x, int z, float rotationY = 0)
    {
        GameObject prefab = Managers.ObjectMng.Spawn(objectType, prefabPath);
